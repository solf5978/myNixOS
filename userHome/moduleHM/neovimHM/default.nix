  ...
  config = {
    ...
    nixCats = {
	  ...
	  ts = with pkgs; [
		...
		prettierd# Code formatter                             # https://github.com/prettier/prettier
		typescript
	    ...
	    #  flake = false;
	    #  };
	      # “Everforest” soft green theme for Neovim       # https://github.com/neanias/everforest-nvim
            onedark-nvim
            vim-sleuth
          ];
        };
